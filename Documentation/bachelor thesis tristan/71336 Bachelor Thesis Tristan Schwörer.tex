%HEADER
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[a4paper,hidelinks, %Format
		12pt, %Font size
		headsepline,
...
%\include{ConfigurationTesting}

\include{ResultDiscussion}
...
\include{AppendixAdditionalTopics}

\stopcontents[appendix]
\include{EidesVers}
%\includepdf[pages=-]{Eidesstattliche27.pdf}
