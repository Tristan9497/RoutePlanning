...
This chapter is structured into three parts. The first two address the individual configuration of all nodes in the simulation as well as in the navigation.
...
\subsection{road\_detection test}
