...
This results in lethal cells in the costmap for each point of the lidar sensor and the left and right lane of the road detection. These points will still have gaps in between each other, which will be filled by using the inflation layer that inflates every point with a defined cost distribution as pictured in figure \ref{costinfl}.\\
\begin{figure}[H]
	\centering
