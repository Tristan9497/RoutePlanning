...
This is necessary since it is unknown if the goal is in the space that has not been explored yet, is perfectly on the future road or if it is in an obstacle.\todo{rewrite}
